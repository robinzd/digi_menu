    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <a href="./pages/address/address.php">
            <div class="card">
                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder">Access Address Section</h5>
                      <p class="mb-0">
                        <span class="text-success text-sm font-weight-bolder">Show Or Hde Header Or Edit Address</span>
                      </p>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder">Access Contact Section</h5>
                      <p class="mb-0">
                        <span class="text-success text-sm font-weight-bolder">Show Or Hde Header Or Edit Contact</span>
                      </p>
                    </div>
                  </div>
                  <div class="col-4 text-end">
        ...
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <a href="./pages/working_hours/working_hours.php">
            <div class="card">
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder">Access Working Hours</h5>
                      <p class="mb-0">
                        <span class="text-success text-sm font-weight-bolder">Show Or Hde Header Or Edit Working Hours</span>
                      </p>
                    </div>
                  </div>
                  <div class="col-4 text-end">
        ...
        <div style="margin-top:5%;">
          <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
            <a href="./pages/follow_us/follow_us.php">
              <div class="card">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder">Access Follow US Section</h5>
                        <p class="mb-0">
                          <span class="text-success text-sm font-weight-bolder">Show Or Hde Header Or Edit Follow Us</span>
                        </p>
                      </div>
                    </div>
                    <div class="col-4 text-end">
      ...
      <div class="row">
        <div class="col-lg-8 mb-4 mx-auto text-center">
          <a href="./index.php" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
            <i class="ni ni-tv-2 text-primary text-sm opacity-10 footer_icons"></i>
          </a>
          ...
          <a href="./footer.php" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
            <i class="ni ni-credit-card text-success text-sm opacity-10 footer_icons" id="active"></i>
          </a>
