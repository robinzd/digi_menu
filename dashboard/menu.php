                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder">Access Menu</h5>
                      <p class="mb-0">
                        <span class="text-success text-sm font-weight-bolder">Show Or Hde or Edit Menu</span>
                      </p>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder">Dish Access</h5>
                      <p class="mb-0">
                        <span class="text-success text-sm font-weight-bolder">Show Or Hde or Edit Dish</span>
                      </p>
                    </div>
                  </div>
                  <div class="col-4 text-end">
      ...
      <div class="row">
        <div class="col-lg-8 mb-4 mx-auto text-center">
          ...
          <a href="./menu.php" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
            <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10 footer_icons" id="active"></i>
          </a>
